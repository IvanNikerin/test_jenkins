...
*/						
		...
		function getPadding(el, name){
			...
			return (
			    ...
			    parseInt("0"+$.css(el, "border"+torl+"Width", true), 10)
				+ parseInt("0"+$.css(el, "border"+borr+"Width", true), 10)
				+ parseInt("0"+$.css(el, "padding"+torl, true), 10)
				+ parseInt("0"+$.css(el, "padding"+borr, true), 10)
				+ parseInt("0"+$.css(el, "margin"+torl, true), 10)
				+ parseInt("0"+$.css(el, "margin"+borr, true), 10)
			);
		};
